const imgOpenModal = document.querySelector(".img-open-modal"); // Image that opens modal on click
...
const changeImg = function (el) {
  el.forEach((pic, i) => {
    pic.addEventListener(`click`, () => {
      modalImg.src = `images/image-product-${i + 1}.jpg`;
      removeWhiteOverlay()
...
picCont.addEventListener("click", function () {
...
// imgThumb.addEventListener(`click`, changeImgThumb);
changeImg(imgThumb);
